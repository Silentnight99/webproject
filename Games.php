				...
				<div class="recommended">
					<div class="recommended-grids">
						<div class="recommended-info">
							<h3><font color="yellow">Games</font></h3>
						</div>
						<?php
						require_once('conn.php');
						  $sql = "SELECT ten, hinhanh, ungdung FROM theloai WHERE theloai='Games'";
						  $ungdung = "SELECT ungdung FROM theloai WHERE theloai='Games'";
						  ...
						  if ($result->num_rows > 0) {
							...
							?>
						<tr>
						<td><a href = "download.php?path=upload/<?php echo $row["ungdung"]; ?>"><?php echo "<img src='images/games/" .$row['hinhanh']."'height = 180' width = '220'>";?></a></td>
